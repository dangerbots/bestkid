...
@Client.on_message(filters.command(["queen"], prefixes=f"{HNDLR}"))
...
@Client.on_message(filters.command(["Queens help"], prefixes=f"{HNDLR}"))
...
🛠 HELP MENU
⚡ COMMANDS
❍ {HNDLR}Queens help - to see a list of commands
